...
REM - Rename ToDoList.pdb with exe version and copy to symbols folder
...
MKDIR D:\Symbols
MKDIR D:\Symbols\ToDoList.pdb
MOVE /Y %REPO%\Core\ToDoList\Unicode_Release\ToDoList.%TDLVER%.pdb D:\Symbols\ToDoList.pdb\
