...
static OUTLOOK_FIELD FIELDS[] = 
{
	...
	OUTLOOK_FIELD(OA_CONVERSATIONTOPIC,		OOC_ITEM,	IDS_OA_CONVERSATIONTOPIC,	TDCA_COMMENTS),
	OUTLOOK_FIELD(OA_CREATIONTIME,			OOC_ITEM,	IDS_OA_CREATIONTIME,		TDCA_CREATIONDATE),
	OUTLOOK_FIELD(OA_ENTRYID,				OOC_ITEM,	IDS_OA_ENTRYID,				TDCA_FILEREF),
	OUTLOOK_FIELD(OA_EXPIRYTIME,			OOC_ITEM,	IDS_OA_EXPIRYTIME,			TDCA_COMMENTS),
	OUTLOOK_FIELD(OA_FLAGREQUEST,			OOC_ITEM,	IDS_OA_FLAGREQUEST,			TDCA_COMMENTS),
	OUTLOOK_FIELD(OA_IMPORTANCE,			OOC_ITEM,	IDS_OA_IMPORTANCE,			TDCA_PRIORITY),
	OUTLOOK_FIELD(OA_LASTMODIFICATIONTIME,	OOC_ITEM,	IDS_OA_LASTMODTIME,			TDCA_LASTMOD),
	OUTLOOK_FIELD(OA_MILEAGE,				OOC_ITEM,	IDS_OA_MILEAGE,				TDCA_COMMENTS),
	OUTLOOK_FIELD(OA_PERMISSION,			OOC_ITEM,	IDS_OA_PERMISSION,			TDCA_COMMENTS),
	...
	OUTLOOK_FIELD(OA_BODY,					OOC_MAIL,	IDS_OA_BODY,				TDCA_COMMENTS),
