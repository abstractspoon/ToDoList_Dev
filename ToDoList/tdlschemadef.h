...
static const CString TDL_DISABLEPASSWORDPROMPTING(_T("DISABLEPASSWORDPROMPTING"));
...
static const CString TDL_TASKRECURRENCEPRESERVECOMMENTS(_T("RECURPRESERVECOMMENTS"));
...
static const CString TDL_TASKCUSTOMATTRIBDISPLAYSTRING(_T("DISPLAYSTRING"));	
