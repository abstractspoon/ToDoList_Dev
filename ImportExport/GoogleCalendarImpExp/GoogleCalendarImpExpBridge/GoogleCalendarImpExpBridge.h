...
class CGoogleCalendarImportBridge : public IImportTasklist
{
public:
	CGoogleCalendarImportBridge();
   ...
   IIMPORT_RESULT Import(LPCWSTR szSrcFilePath, ITaskList* pDestTaskFile, bool bSilent, IPreferences* pPrefs, LPCWSTR szKey);
};

class CGoogleCalendarExportBridge : public IExportTasklist
{
public:
	CGoogleCalendarExportBridge();
...
{
   return new CGoogleCalendarImportBridge();
}
