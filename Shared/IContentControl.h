...
// helper method
static IContent* CreateContentInterface(LPCTSTR szDllPath, int* pVer = 0)
{
...
static BOOL IsContentDll(LPCTSTR szDllPath)
{
    HMODULE hDll = LoadLibrary(szDllPath);
...
public:
	...
	virtual LPCTSTR GetTypeDescription() const = 0;
	...
	virtual int ConvertToHtml(const unsigned char* pContent, int nLength,
							  LPCTSTR szCharSet, LPTSTR& szHtml, LPCTSTR szImageDir) = 0;
...
public:
	...
	virtual bool SetTextContent(LPCTSTR szContent, BOOL bResetSelection) = 0;
