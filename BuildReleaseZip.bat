...
SET FILELIST=%FILELIST%;EisenhowerUIExtensionData.dll
...
SET FILELIST=%FILELIST%;TaskDatesUIExtensionBridge.dll
SET FILELIST=%FILELIST%;TaskDatesUIExtensionCore.dll
