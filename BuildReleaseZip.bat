...
SET FILELIST=%FILELIST%;JSViewUIExtensionBridge.dll
SET FILELIST=%FILELIST%;JSViewUIExtensionCore.dll
...
SET FILELIST=%FILELIST%;Microsoft.Web.WebView2.Core.dll
SET FILELIST=%FILELIST%;Microsoft.Web.WebView2.WinForms.dll
SET FILELIST=%FILELIST%;WebView2Loader.dll
