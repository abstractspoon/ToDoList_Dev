...
/////////////////////////////////////////////////////////////////////////////////
// This class is exported from WorkloadUIExtensionBridge.dll

class CWorkloadUIExtensionBridge : public IUIExtension
{
public:
	CWorkloadUIExtensionBridge();
...
class CWorkloadUIExtensionBridgeWindow : public IUIExtensionWindow
{
public:
	CWorkloadUIExtensionBridgeWindow(ITransText* pTT);
...
protected:
   gcroot<WorkloadUIExtensionCore^> m_wnd;
   ITransText* m_pTT;
...
{
   return new CWorkloadUIExtensionBridge();
}
