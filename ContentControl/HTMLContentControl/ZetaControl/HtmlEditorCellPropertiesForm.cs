		...
		Form
	{
		...
		private void FillCellValuesToDialogControls()
		{
			if (_cells.Count > 0)
			{
				...
				CheckState noWrap = CheckState.Unchecked;

				int differentContainsHeadlineCount = 0;
				CheckState containsHeadline = CheckState.Unchecked;
				...
				foreach (var cell in _cells)
				{
					...
					string currentWidth = Convert.ToString(
					   cellElement.getAttribute(@"width", 0));
					...
					var currentHeight = Convert.ToString(
					   cellElement.getAttribute(@"height", 0));
				...
				{
					foreach (Pair<string, HorizontalAlignmentType> p in
						horizontalAlignmentComboBox.Items)
					{
						if (p.Value == horizontalAlignmentIndex)
						{
				...
				{
					foreach (Pair<string, VerticalAlignmentType> p in
						verticalAlignmentComboBox.Items)
					{
						if (p.Value == verticalAlignmentIndex)
						{
				...
				var isWidthPercentage = width.IndexOf(@"%") >= 0;
				width = width.Trim('%');
				width = width.Trim();
				...
				var isHeightPercentage = height.IndexOf(@"%") >= 0;
				height = height.Trim('%');
				height = height.Trim();
			...
			EventArgs e)
		{
			...
			try
			{
				...
				horizontalAlignmentComboBox.Items.Add(new Pair<string, HorizontalAlignmentType>(StringHelper.GetEnumDescription(HorizontalAlignmentType.Standard), HorizontalAlignmentType.Standard));
				horizontalAlignmentComboBox.Items.Add(new Pair<string, HorizontalAlignmentType>(StringHelper.GetEnumDescription(HorizontalAlignmentType.Left), HorizontalAlignmentType.Left));
				horizontalAlignmentComboBox.Items.Add(new Pair<string, HorizontalAlignmentType>(StringHelper.GetEnumDescription(HorizontalAlignmentType.Right), HorizontalAlignmentType.Right));
				horizontalAlignmentComboBox.Items.Add(new Pair<string, HorizontalAlignmentType>(StringHelper.GetEnumDescription(HorizontalAlignmentType.Center), HorizontalAlignmentType.Center));
				horizontalAlignmentComboBox.Items.Add(new Pair<string, HorizontalAlignmentType>(StringHelper.GetEnumDescription(HorizontalAlignmentType.Justify), HorizontalAlignmentType.Justify));

				verticalAlignmentComboBox.Items.Clear();
				verticalAlignmentComboBox.Items.Add(new Pair<string, VerticalAlignmentType>(StringHelper.GetEnumDescription(VerticalAlignmentType.Standard), VerticalAlignmentType.Standard));
				verticalAlignmentComboBox.Items.Add(new Pair<string, VerticalAlignmentType>(StringHelper.GetEnumDescription(VerticalAlignmentType.Top), VerticalAlignmentType.Top));
				verticalAlignmentComboBox.Items.Add(new Pair<string, VerticalAlignmentType>(StringHelper.GetEnumDescription(VerticalAlignmentType.Middle), VerticalAlignmentType.Middle));
				verticalAlignmentComboBox.Items.Add(new Pair<string, VerticalAlignmentType>(StringHelper.GetEnumDescription(VerticalAlignmentType.BaseLine), VerticalAlignmentType.BaseLine));
				verticalAlignmentComboBox.Items.Add(new Pair<string, VerticalAlignmentType>(StringHelper.GetEnumDescription(VerticalAlignmentType.Bottom), VerticalAlignmentType.Bottom));
