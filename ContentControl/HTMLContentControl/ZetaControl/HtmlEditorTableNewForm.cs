	...
	public partial class HtmlEditorTableNewForm : Form
	{
			...
			int count)
		{
			...
			for (var j = 0; j < count; ++j)
			{
				...
				{
					var cell = (IHTMLTableCell)row.insertCell(-1);
			...
			EventArgs e)
		{
			...
			horizontalAlignmentComboBox.Items.Add(
				new Pair<string, HtmlEditorCellPropertiesForm.HorizontalAlignmentType>(
			...
			verticalAlignmentComboBox.Items.Add(
				new Pair<string, HtmlEditorCellPropertiesForm.VerticalAlignmentType>(
			...
			EventArgs e)
		{
			...
			if (ExternalInformationProvider != null)
			{
				...
				ExternalInformationProvider.SavePerUserPerWorkstationValue(StoreID +
				                                                           ...
				                                                           horizontalAlignmentComboBox.SelectedIndex.ToString());
				ExternalInformationProvider.SavePerUserPerWorkstationValue(StoreID +
				                                                           @"HtmlEditorTableNewDialog.VerticalAlignmentIndex",
				                                                           verticalAlignmentComboBox.SelectedIndex.ToString());
			}
		}
		...
		private string calculateHorizontalAlignment()
		{
			...
			var p =
				(Pair<string, HtmlEditorCellPropertiesForm.HorizontalAlignmentType>)
		...
		private string calculateVerticalAlignment()
		{
			...
			var p =
				(Pair<string, HtmlEditorCellPropertiesForm.VerticalAlignmentType>)
			...
			{
				return string.Format(@" valign=""{0}""", a);
			}
		}
