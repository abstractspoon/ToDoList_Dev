...
static const COLORBREWER_PALETTEGROUP COLORBREWER_GROUPS[] = 
{
	...
	{ 
		CBPT_SEQUENTIAL, _T("Purples"), 7,
		{
			...
			{ 9, { 0x00fcfbfd, 0x00efedf5, 0x00dadaeb, 0x00bcbddc, 0x009e9ac8, 0x00807dba, 0x006a51a3, 0x0054278f, 0x003f007d } },
			{ 0, { CLR_NONE } }
		}
	},
	...
	{ 
		CBPT_SEQUENTIAL, _T("Red"), 7,
		{
			...
			{ 9, { 0x00fff5f0, 0x00fee0d2, 0x00fcbba1, 0x00fc9272, 0x00fb6a4a, 0x00ef3b2c, 0x00cb181d, 0x00a50f15, 0x0067000d } },
			{ 0, { CLR_NONE } }
		}
	},
	...
	{ 
		CBPT_DIVERGING, _T("Purple-Red-Green"), 9,
		{
			...
			{ 11, { 0x0040004b, 0x00762a83, 0x009970ab, 0x00c2a5cf, 0x00e7d4e8, 0x00f7f7f7, 0x00d9f0d3, 0x00a6dba0, 0x005aae61, 0x001b7837, 0x0000441b } },
			{ 0, { CLR_NONE } }
		}
	},
