...
# define		rtfAnsiCodePageCharSet	1 /*jrm21-assume this works! */
# define		rtfMacCharSet		2
# define		rtfPcCharSet		3
# define		rtfPcaCharSet		4
...
# define		rtfTOCN			81	
#define			rtfShapeGroup		82 /*jrm21*/
# define		rtfMaxDestination	83	/* highest dest + 1 */
...
# define		rtfBasedOn		1
# define		rtfNext			2
# define		rtfStyleAutoUpdate	3 /*jrm21*/
...
#define		rtfDefLanguageFarEast	150	/*jrm21*/
#define		rtfWindowCaption	151	/*jrm21*/
#define		rtfAutoFormatDocType	152	/*jrm21*/
#define		rtfOriginallyText	153	/*jrm21*/
#define		rtfOriginallyHTML	154	/*jrm21*/
#define		rtfHozDocRendering	155	/*jrm21*/
#define		rtfVertDocRendering	156	/*jrm21*/
#define		rtfCompressingJust	157	/*jrm21*/
#define		rtfExpandingJust	158	/*jrm21*/
#define		rtfLineBasedOnGrid	159	/*jrm21*/
/* Document views/zoom level */
#define		rtfViewKindNum		78	/*jrm21*/
#define		rtfViewScaleNum		79	/*jrm21*/
#define		rtfViewZoomKind		79	/*jrm21*/
#define		rtfPrivate		79	/*jrm21*/
/* footnote stuff */
...
#define		rtfNoLeadingXSpace	66	/*jrm21*/
#define		rtfBodyBeforeHeader	67	/*jrm21*/
/* for Word 6.0 Japanese compatibility. (!!) */
#define		rtfNoBalanceSingleByte	68	/*jrm21*/
#define		rtfExpandCharSpaces	69	/*jrm21*/
#define		rtfNoCentreLineHeights	70	/*jrm21*/
#define		rtfUsePrinterMetrics	71	/*jrm21*/
#define		rtfSmallCapsMacFive	72	/*jrm21*/
#define		rtfNoLeadMacFive	73	/*jrm21*/
#define		rtfNoSpaceForUnderline	74	/*jrm21*/
#define		rtfNoUnderlineTrailSp	75	/*jrm21*/
#define		rtfNoBkSlashToYen	76	/*jrm21*/
#define		rtfOldAutoSpacing	77	/*jrm21*/
#define		rtfNoWord97LineBrkRules	78	/*jrm21*/
#define		rtfWord97BorderRules	79	/*jrm21*/
#define		rtfNoAdjustLineHeightTbl 80	/*jrm21*/
#define		rtfSuppressTopSomething	81	/*jrm21!!*/

/* Forms */
# define		rtfFormProtected	82	/* new in 1.10 */
# define		rtfAllProtected		83	/* new in 1.10 */
# define		rtfFormShading		84	/* new in 1.10 */
# define		rtfFormDisplay		85	/* new in 1.10 */
# define		rtfPrintData		86	/* new in 1.10 */
/* revision marks */
# define		rtfRevProtected		87	/* new in 1.10 */
# define		rtfRevisions		88
# define		rtfRevDisplay		89
# define		rtfRevBar		90
/* comments */
# define		rtfAnnotProtected	91	/* new in 1.10 */
/* bi-directional controls */
# define		rtfRTLDoc		92	/* new in 1.10 */
# define		rtfLTRDoc		93	/* new in 1.10 */
/* Click-and-type */
#define		rtfClickAndType		94 /*jrm21*/
/* snip some far east stuff - Kinsoku chars */
/* Drawing Grid */
#define		rtfDrawGridHozSpace	95 /*jrm21*/
#define		rtfDrawGridVertSpace	96 /*jrm21*/
#define		rtfDrawGridHozOrigin	97 /*jrm21*/
#define		rtfDrawGridVertOrigin	98 /*jrm21*/
#define		rtfDrawGridShowHorLine	99 /*jrm21*/
#define		rtfDrawGridShowVertLine	100 /*jrm21*/
#define		rtfDrawGridSnapTo	101 /*jrm21*/
#define		rtfDrawGridFollowMargins 102 /*jrm21*/
/* Page Borders */
#define		rtfPageBorderHead	103	/*jrm21*/
#define		rtfPageBorderFoot	104	/*jrm21*/

/* Some names I've made up for tokens used by RTF-J (Japanese) and Far East */
#define		rtfAutoSpaceAlpha	105	/*jrm21*/
#define		rtfAutoSpaceNum		106	/*jrm21*/
#define		rtfFontAlignAuto	107	/*jrm21*/
...
/* Asian Controls */
#define			rtfHozSectRendering	54 /*jrm21*/
#define			rtfVertSectRendering	55 /*jrm21*/
/* Text flow */
/* Line and character grid */
#define		rtfSectExpand		100 /*jrm21*/
#define		rtfSectLineGrid		100 /*jrm21*/
#define		rtfSectDefaultState	100 /*jrm21*/
#define		rtfSectCharsPerLine	100 /*jrm21*/
#define		rtfSectCPLLPerPage	100 /*jrm21*/
#define		rtfSectTextSnapToGrid	100 /*jrm21*/

/* section break */
/* line numbering */
/* page information */
/* page numbers */
# define		rtfPageNumLevel		56	/* new in 1.10 */
# define		rtfSectUnlocked		57	/* new in 1.10 */
...
/* next 3 are word97/2000 */
#define			rtfParList		39 /*jrm21*/
#define			rtfParListLevel		40 /*jrm21*/
#define			rtfParListText		41 /*jrm21*/

#define			rtfCellVertAlignTop	42 /*jrm21*/
#define			rtfCellVertAlignCentre	43 /*jrm21*/
#define			rtfCellVertAlignBottom	44 /*jrm21*/
#define			rtfCellVertTextAlignL	45 /*jrm21*/
#define			rtfCellVertTextAlignR	46 /*jrm21*/
...
# define		rtfInTable		3
#define			rtfParaNesting			104	/* jrm21 */
# define		rtfKeep			4
# define		rtfNoWidowControl	5	/* new in 1.10 */
# define		rtfWidowControl			105	/* jrm21 */
...
# define		rtfRightIndentAdjust		106 /* jrm21 */
...
#define			rtfNoProof		32 /*jrm21*/
# define		rtfCharStyleNum		33	/* new in 1.10 */
# define		rtfCharCharSet		34	/* new in 1.10 */
# define		rtfLanguage		35
# define		rtfGray			36
#define			rtfCharGridNum		37 /*jrm21*/
#define			rtfLanguageFarEast	38 /*jrm21*/
#define			rtfLanguageFarEastNoProof 39 /*jrm21*/
#define			rtfLanguageNoProof	40 /*jrm21*/



# define	rtfPictAttr	13
#define		rtfEMFPict		32 /*jrm21*/
#define		rtfPNGPict		33 /*jrm21*/
#define		rtfJPEGPict		34 /*jrm21*/
#define		rtfWord97Pict		35 /*jrm21*/
#define		rtfNotWord97Pict	36 /*jrm21*/
# define		rtfMacQD		0
...
#define			rtfPicUnitsPerInch	22 /*jrm21*/
#define			rtfPicIdent		23 /*jrm21*/
#define			rtfPicTag		24 /*jrm21*/
...
#endif /* doesn't get following though... */
