...
enum TDC_ATTRIBUTE
{
	...
	TDCA_DEPRECATED_1,	// TDCA_DONEDATE_RELATIVE
	TDCA_DEPRECATED_2,	// TDCA_DUEDATE_RELATIVE
	TDCA_DEPRECATED_3,	// TDCA_STARTDATE_RELATIVE
	TDCA_DEPRECATED_4,	// TDCA_CREATIONDATE_RELATIVE
	TDCA_DEPRECATED_5,	// TDCA_LASTMOD_RELATIVE
...
enum TDC_REGULARITY
{
	...
	TDIR_DEPRECATED_1,					// DAY_RECREATEAFTERNDAYS
	TDIR_DEPRECATED_2,					// WEEK_RECREATEAFTERNWEEKS
	TDIR_MONTH_SPECIFIC_DOW_NMONTHS,
	TDIR_DEPRECATED_3,					// MONTH_RECREATEAFTERNMONTHS
	TDIR_YEAR_SPECIFIC_DOW_MONTHS,
	TDIR_DEPRECATED_4,					// YEAR_RECREATEAFTERNYEARS
