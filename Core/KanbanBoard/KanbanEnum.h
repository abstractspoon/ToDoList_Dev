...
enum // options
{
	KBCF_HIDEPARENTTASKS				= 0x0001,
	KBCF_HIDEEMPTYCOLUMNS				= 0x0002,
	...
	KBCF_DUEHAVEHIGHESTPRIORITYRISK		= 0x1000,
	KBCF_DONEHAVELOWESTPRIORITYRISK		= 0x2000,
	KBCF_PARENTSSHOWHIGHESTPRIORITYRISK = 0x4000,
	KBCF_HIDESUBTASKS					= 0x8000,
	// 	KBCF_		= 0x0080,
};
