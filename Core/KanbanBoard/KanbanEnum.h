...
enum // options
{
	...
	KBCF_SORTGROUPSASCENDING                = 0x00020000,
	KBCF_HIDENONEGROUP						= 0x00040000,
	KBCF_SORTNONEGROUPBELOW					= 0x00080000,
	KBCF_SHOWISODATES						= 0x00100000,
	KBCF_ALTKEYOVERRIDESMAXCOUNT			= 0x00200000,
	KBCF_SHOWMIXEDCOMPLETIONSTATE			= 0x00400000,
	// 	KBCF_		= 0x0080,
};
