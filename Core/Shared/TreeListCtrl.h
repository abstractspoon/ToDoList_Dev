...
public:
	...
	void SetFocus();
	void ShowCheckboxes(UINT nUnthemedBitmapID, BOOL bShow = TRUE) { m_tree.ShowCheckboxes(nUnthemedBitmapID, bShow); }
	void ShowIcons(BOOL bShow = TRUE) { m_tree.ShowIcons(bShow); }
