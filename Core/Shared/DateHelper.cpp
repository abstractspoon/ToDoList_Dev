...
{
	NULLDATE_CHECKRET(date, NullDate())
...
{
	NULLDATE_CHECKRET(date1, FALSE)
	NULLDATE_CHECKRET(date2, FALSE)
...
{
	NULLDATE_CHECKRET(dtDateOnly, NullDate())
