...
//{{AFX_MSG_MAP(CToDoListWnd)
	...
	ON_COMMAND_RANGE(ID_NEWTASK_ATTOP, ID_NEWSUBTASK_ONTASK, OnNewTask)
	...
	ON_UPDATE_COMMAND_UI_RANGE(ID_NEWTASK_ATTOP, ID_NEWSUBTASK_ONTASK, OnUpdateNewTask)
