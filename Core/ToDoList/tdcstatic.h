...
static const TDCCONTROL FTDCCONTROLS[] = 
{
	...
	{ WC_STATIC,	IDS_TDC_GROUPBY, SS_CENTERIMAGE | WS_NOTVISIBLE, 0, 0,184,40,8, IDC_GROUPBY },
	{ WC_COMBOBOX,	0, CBS_DROPDOWNLIST | CBS_SORT | WS_VSCROLL | WS_TABSTOP | WS_NOTVISIBLE, 0, 42,182,100,13, IDC_GROUPBYATTRIB },
};
