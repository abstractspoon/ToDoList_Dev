...
CTDLAttributeListBox::CTDLAttributeListBox(const CTDCCustomAttribDefinitionArray& aAttribDefs, BOOL bIncludeReadonly)
{
	...
	m_aAttribs.Add(ATTRIBVIS(IDS_TDLBC_TIMEEST,			TDCA_TIMEESTIMATE,	FALSE)); 
