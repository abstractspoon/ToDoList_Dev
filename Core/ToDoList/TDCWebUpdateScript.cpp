...
const LPCTSTR UPDATE_SCRIPT_URL		= _T("https://ftp.abstractspoon.com/todolist_update_new.txt");
const LPCTSTR PRERELEASE_SCRIPT_URL	= _T("https://ftp.abstractspoon.com/todolist_pre_new.txt");
