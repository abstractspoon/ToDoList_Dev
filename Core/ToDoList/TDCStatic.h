...
static const LPCTSTR TASKTREE_TYPEID = _T("TASKTREE_TYPE");
static const LPCTSTR LISTVIEW_TYPEID = _T("LISTVIEW_TYPE");
...
static const TDCATTRIBUTE TASKATTRIBUTES[] = 
{
	...
	{ TDCA_RECURRENCE,			TDCAG_DATETIME,		IDS_TDLBC_RECURRENCE },
