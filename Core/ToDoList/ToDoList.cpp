...
BEGIN_MESSAGE_MAP(CToDoListApp, CWinApp)
	...
	ON_COMMAND(ID_DEBUG_SHOWUPDATEDLG, OnDebugShowUpdateDlg)
	ON_COMMAND(ID_DEBUG_SHOWSCRIPTDLG, OnDebugShowScriptDlg)
	ON_COMMAND(ID_DEBUG_TASKDIALOG_WARNING, OnDebugTaskDialogWarning)
	ON_COMMAND(ID_DEBUG_TASKDIALOG_ERROR, OnDebugTaskDialogError)
	ON_COMMAND(ID_DEBUG_SHOWLANGDLG, OnDebugShowLanguageDlg)
