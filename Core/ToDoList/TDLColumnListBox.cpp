...
CTDLColumnListBox::CTDLColumnListBox()
{
	...
	m_aColumns.Add(COLUMNVIS(IDS_TDLBC_TIMEEST,		TDCC_TIMEESTIMATE,	TRUE)); 
	...
	m_aColumns.Add(COLUMNVIS(IDS_TDLBC_STARTDATE,	TDCC_STARTDATE,		TRUE));
	...
	m_aColumns.Add(COLUMNVIS(IDS_TDLBC_DEPENDS,		TDCC_DEPENDENCY,	TRUE)); 
	...
	m_aColumns.Add(COLUMNVIS(IDS_TDLBC_REMAINING,	TDCC_TIMEREMAINING,	FALSE)); 
