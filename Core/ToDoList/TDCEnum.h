...
{ 
	...
	MM_COMMENTS, 
	MM_TOOLARGS, 
	MM_ATTRIBUTECTRLLABEL,
	MM_ATTRIBUTECTRLVALUE,
};
...
enum TDC_STYLE
{
	...
	TDCS_INCLUDEREFERENCESINCALCS,
	TDCS_SHOWMIXEDCOMPLETIONSTATE,
	TDCS_SHOWIMAGETIPS,
...
enum FIND_OPERATOR
{
	...
	FOP_SET,
	FOP_NOT_SET,
	FOP_DEPENDS_COMPLETE, // Applies only to TDCA_DEPENDENCY
};
...
enum
{
	...
	TDC_PRIORITYORRISK_DONETASKS	= -1,
	TDC_PRIORITYORRISK_MIN			= 0,
	TDC_PRIORITYORRISK_MINLEVELS	= 2,
	TDC_PRIORITYORRISK_MAX			= 10,
	TDC_PRIORITYORRISK_OVERDUETASKS	= 11,
	TDC_PRIORITYORRISK_MAXLEVELS	= 11,
...
enum // FILTER_OPTIONS
{
	...
	FO_HIDEUNDONEDEPENDS	= 0x0400,
	// New items here

	FO_GLOBALS		= (FO_HIDEOVERDUE | FO_HIDEDONE | FO_SHOWALLSUB | FO_HIDEUNDONEDEPENDS),
...
enum // LISTVIEW_OPTIONS
{
	...
	LVO_SORTNONEGROUPBELOW  = 0x0010,
};

enum // FILTER_MISC
{
	FM_ANYPRIORITYORRISK	= -1,
	FM_NOPRIORITYORRISK		= -2, // TDC_PRIORITYORRISK_NONE
};
...
enum TDC_REMINDERPERIOD
{
	...
	TDCRP_45_MINS		= 45,
	TDCRP_60_MINS		= 60,
	TDCRP_1_HOUR		= TDCRP_60_MINS,
	TDCRP_2_HOURS		= (2 * TDCRP_1_HOUR),
	TDCRP_3_HOURS		= (3 * TDCRP_1_HOUR),
	TDCRP_4_HOURS		= (4 * TDCRP_1_HOUR),
	TDCRP_5_HOURS		= (5 * TDCRP_1_HOUR),
	TDCRP_6_HOURS		= (6 * TDCRP_1_HOUR),
	TDCRP_12_HOURS		= (12 * TDCRP_1_HOUR),
	TDCRP_24_HOURS		= (24 * TDCRP_1_HOUR),
	TDCRP_1_DAY			= TDCRP_24_HOURS,
	TDCRP_2_DAYS		= (2 * TDCRP_1_DAY),
	TDCRP_3_DAYS		= (3 * TDCRP_1_DAY),
	TDCRP_4_DAYS		= (4 * TDCRP_1_DAY),
	TDCRP_5_DAYS		= (5 * TDCRP_1_DAY),
	TDCRP_6_DAYS		= (6 * TDCRP_1_DAY),
	TDCRP_7_DAYS		= (7 * TDCRP_1_DAY),
	TDCRP_1_WEEK		= TDCRP_7_DAYS,
	TDCRP_2_WEEKS		= (2 * TDCRP_1_WEEK),
	TDCRP_3_WEEKS		= (3 * TDCRP_1_WEEK),
	TDCRP_4_WEEKS		= (4 * TDCRP_1_WEEK),
	TDCRP_1_MONTH		= (30 * TDCRP_1_DAY),
	TDCRP_2_MONTHS		= (2 * TDCRP_1_MONTH),
	TDCRP_3_MONTHS		= (3 * TDCRP_1_MONTH),
	TDCRP_4_MONTHS		= (4 * TDCRP_1_MONTH),
	TDCRP_5_MONTHS		= (5 * TDCRP_1_MONTH),
	TDCRP_6_MONTHS		= (6 * TDCRP_1_MONTH),
	TDCRP_9_MONTHS		= (9 * TDCRP_1_MONTH),
	TDCRP_12_MONTHS		= (12 * TDCRP_1_MONTH),
	TDCRP_1_YEAR		= TDCRP_12_MONTHS,
};
