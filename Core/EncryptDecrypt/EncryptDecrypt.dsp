...
# ADD CPP /nologo /MDd /W4 /Gm /GX /Zi /Od /D "_USRDLL" /D "ENCRYPTDECRYPT_EXPORTS" /D "_EXPORTING" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_UNICODE" /D "UNICODE" /Yu"stdafx.h" /FD /GZ /c
...
# ADD CPP /nologo /MD /W4 /GX /Zi /O1 /D "_USRDLL" /D "ENCRYPTDECRYPT_EXPORTS" /D "_EXPORTING" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_UNICODE" /D "UNICODE" /Yu"stdafx.h" /FD /c
# SUBTRACT CPP /Fr
...
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=mkdir ..\ToDoList	mkdir ..\ToDoList\unicode_release	copy unicode_release\encryptdecrypt.dll ..\todolist\unicode_release /y
# End Special Build Tool
