...
enum // options
{
	...
	WLCF_PREFERTIMESPENTFORCALCS		= 0x0100,
	WLCF_RECALCALLOCATIONS				= 0x0200,
	WLCF_RECALCPROPORTIONALLY			= 0x0400,
	WLCF_ALLOWPARENTALLOCATIONS			= 0x0800,
	WLCF_INCLUDEDATELESSTASKSINPERIOD	= 0x1000,
	WLCF_SHOWMIXEDCOMPLETIONSTATE		= 0x2000,


	WLCF_ALLOCATION_OPTIONS				= (WLCF_PREFERTIMEESTFORCALCS |
										   WLCF_PREFERTIMESPENTFORCALCS |
										   WLCF_CALCMISSINGALLOCATIONS |
										   WLCF_RECALCALLOCATIONS | 
										   WLCF_RECALCPROPORTIONALLY),
	WLCF_TOTALS_OPTIONS					= (WLCF_ALLOWPARENTALLOCATIONS |
										   WLCF_INCLUDEDATELESSTASKSINPERIOD),
};
