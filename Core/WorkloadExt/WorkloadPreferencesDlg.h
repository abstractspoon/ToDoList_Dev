...
public:
	...
	BOOL GetIncludeCompletedTasksInCalcs() const { return m_bIncludeDoneTasksInCalcs; }
...
// Dialog Data
	...
	//}}AFX_DATA
	BOOL	m_bIncludeDoneTasksInCalcs;
...
public:
	...
	BOOL GetIncludeCompletedTasksInCalcs() const { return m_page.GetIncludeCompletedTasksInCalcs(); }
