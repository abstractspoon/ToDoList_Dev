...
protected:
	...
	LRESULT OnAllocationsListCustomDraw(NMLVCUSTOMDRAW* pLVCD, const CIntArray& aColWidths);
	...
	// Non-virtual members
	void DrawAllocationListItem(CDC* pDC, int nItem, const CIntArray& aColWidths, const WORKLOADITEM& wi, BOOL bSelected);
