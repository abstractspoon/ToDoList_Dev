...
void CToDoListWnd::UpdateUDTsInToolbar(UDTCHANGETYPE nChange)
{
	...
	if (bWantInToolbar && (bAddToMainToolbar || bAddToCustomToolbar))
	{
		...
		{
			th.AppendToolsToToolbar(aTools, m_toolbarMain, ID_PREFERENCES, FALSE);
		...
		{
			th.AppendToolsToToolbar(aTools, m_toolbarCustom, prefs.GetLastCustomToolbarButtonID(), FALSE);
		}
	}
