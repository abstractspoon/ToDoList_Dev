...
CToDoCtrl::CToDoCtrl(const CTDLContentMgr& mgrContent, const CShortcutManager& mgrShortcuts, const CONTENTFORMAT& cfDefault, const TDCCOLEDITFILTERVISIBILITY& visDefault) 
	: 
	m_bArchive(FALSE),
