...
static char *GetFileString( char *string, int n, FILE *stream )
{
	return fgets( string, n, stream );
}

static wchar_t *GetFileString( wchar_t *string, int n, FILE *stream )
{
	return fgetws( string, n, stream );
}

// Same with strchr
static char *FindCharInString( const char *string, int c )
{	
...
static wchar_t *FindCharInString( const wchar_t *string, wint_t c )
{	
