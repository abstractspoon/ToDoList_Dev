...
%PATHPZIP% %REPO%\Core\ToDoList_Core.sln /ZP %REPO%\..\ToDoList_Prev\9.3\ToDoList_src_Core.9.3._.zip /ML /NM

ECHO Zipping %REPO%\Plugins\ToDoList_Plugins.sln
%PATHPZIP% %REPO%\Plugins\ToDoList_Plugins.sln /ZP %REPO%\..\ToDoList_Prev\9.3\ToDoList_src_Plugins.9.3._.zip /ML /NM
