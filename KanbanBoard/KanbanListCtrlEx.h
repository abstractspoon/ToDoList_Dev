...
class CKanbanListCtrlEx : public CTreeCtrl
{
	DECLARE_DYNAMIC(CKanbanListCtrlEx);

// Construction
public:
	CKanbanListCtrlEx(const CKanbanItemMap& data, 
...
class CKanbanListCtrlExArray : public CArray<CKanbanListCtrlEx*, CKanbanListCtrlEx*&>
{
public:
	...
	int Find(const CKanbanListCtrlEx* pList) const;

	CKanbanListCtrlEx* Get(DWORD dwTaskID) const;
	CKanbanListCtrlEx* Get(DWORD dwTaskID, HTREEITEM& hti) const;
	CKanbanListCtrlEx* Get(HWND hWnd) const;
	CKanbanListCtrlEx* Get(const CString& sAttribValue) const;
	CKanbanListCtrlEx* GetFirstNonEmpty() const;
	CKanbanListCtrlEx* GetLastNonEmpty() const;
	CKanbanListCtrlEx* GetBacklog() const;
	...
	CKanbanListCtrlEx* GetNext(const CKanbanListCtrlEx* pList, BOOL bNext, BOOL bExcludeEmpty, BOOL bFixedColumns) const;
	CKanbanListCtrlEx* HitTest(const CPoint& ptScreen, BOOL* pbHeader = NULL) const;
