; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	D:\_code\RTFContentCtrl\EditWebLinkDlg.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
_THIS_FILE DB	'EditWebLinkDlg.cpp', 00H
_DATA	ENDS
CONST	SEGMENT
...
$SG171424 DB	'h', 00H, 't', 00H, 't', 00H, 'p', 00H, ':', 00H, '/', 00H
	DB	'/', 00H, 'w', 00H, 'w', 00H, 'w', 00H, '.', 00H, 00H, 00H
CONST	ENDS
PUBLIC	??_7CEditWebLinkDlg@@6B@			; CEditWebLinkDlg::`vftable'
PUBLIC	??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z		; CEditWebLinkDlg::CEditWebLinkDlg
PUBLIC	??_R4CEditWebLinkDlg@@6B@			; CEditWebLinkDlg::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVCEditWebLinkDlg@@@8			; CEditWebLinkDlg `RTTI Type Descriptor'
PUBLIC	??_R3CEditWebLinkDlg@@8				; CEditWebLinkDlg::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2CEditWebLinkDlg@@8				; CEditWebLinkDlg::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@CEditWebLinkDlg@@8		; CEditWebLinkDlg::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
PUBLIC	?GetMessageMap@CEditWebLinkDlg@@MBEPBUAFX_MSGMAP@@XZ ; CEditWebLinkDlg::GetMessageMap
PUBLIC	?DoDataExchange@CEditWebLinkDlg@@MAEXPAVCDataExchange@@@Z ; CEditWebLinkDlg::DoDataExchange
...
EXTRN	??_ECEditWebLinkDlg@@UAEPAXI@Z:PROC		; CEditWebLinkDlg::`vector deleting destructor'
...
;	COMDAT ??_R2CObject@@8
; File d:\_code\rtfcontentctrl\editweblinkdlg.cpp
rdata$r	SEGMENT
...
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@CEditWebLinkDlg@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@CEditWebLinkDlg@@8 DD FLAT:??_R0?AVCEditWebLinkDlg@@@8 ; CEditWebLinkDlg::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	04H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3CEditWebLinkDlg@@8
rdata$r	ENDS
;	COMDAT ??_R2CEditWebLinkDlg@@8
rdata$r	SEGMENT
??_R2CEditWebLinkDlg@@8 DD FLAT:??_R1A@?0A@EA@CEditWebLinkDlg@@8 ; CEditWebLinkDlg::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@CDialog@@8
	DD	FLAT:??_R1A@?0A@EA@CWnd@@8
	DD	FLAT:??_R1A@?0A@EA@CCmdTarget@@8
	DD	FLAT:??_R1A@?0A@EA@CObject@@8
rdata$r	ENDS
;	COMDAT ??_R3CEditWebLinkDlg@@8
rdata$r	SEGMENT
??_R3CEditWebLinkDlg@@8 DD 00H				; CEditWebLinkDlg::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	05H
	DD	FLAT:??_R2CEditWebLinkDlg@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVCEditWebLinkDlg@@@8
_DATA	SEGMENT
??_R0?AVCEditWebLinkDlg@@@8 DD FLAT:??_7type_info@@6B@	; CEditWebLinkDlg `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVCEditWebLinkDlg@@', 00H
_DATA	ENDS
;	COMDAT ??_R4CEditWebLinkDlg@@6B@
rdata$r	SEGMENT
??_R4CEditWebLinkDlg@@6B@ DD 00H			; CEditWebLinkDlg::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVCEditWebLinkDlg@@@8
	DD	FLAT:??_R3CEditWebLinkDlg@@8
rdata$r	ENDS
;	COMDAT ??_7CEditWebLinkDlg@@6B@
CONST	SEGMENT
??_7CEditWebLinkDlg@@6B@ DD FLAT:??_R4CEditWebLinkDlg@@6B@ ; CEditWebLinkDlg::`vftable'
	DD	FLAT:?GetRuntimeClass@CDialog@@UBEPAUCRuntimeClass@@XZ
	DD	FLAT:??_ECEditWebLinkDlg@@UAEPAXI@Z
	...
	DD	FLAT:?GetMessageMap@CEditWebLinkDlg@@MBEPBUAFX_MSGMAP@@XZ
	...
	DD	FLAT:?DoDataExchange@CEditWebLinkDlg@@MAEXPAVCDataExchange@@@Z
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z$1
__ehfuncinfo$??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
rtc$IMZ	ENDS
;	COMDAT ??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z
_TEXT	SEGMENT
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
_pParent$ = 8						; size = 4
??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z PROC		; CEditWebLinkDlg::CEditWebLinkDlg, COMDAT
; _this$ = ecx
...
; 20   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx], OFFSET ??_7CEditWebLinkDlg@@6B@
	mov	ecx, DWORD PTR _this$[ebp]
...
; 21   : 	//{{AFX_DATA_INIT(CEditWebLinkDlg)
; 22   : 	m_sWebLink = _T("http://www.");

	mov	esi, esp
	push	OFFSET $SG171424
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 148				; 00000094H
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1CDialog@@UAE@XZ			; CDialog::~CDialog
__unwindfunclet$??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z$1:
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 148				; 00000094H
	mov	esi, esp
	...
	cmp	esi, esp
	jmp	__RTC_CheckEsp
__ehhandler$??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-12]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??0CEditWebLinkDlg@@QAE@PAVCWnd@@@Z ENDP		; CEditWebLinkDlg::CEditWebLinkDlg
PUBLIC	??1CEditWebLinkDlg@@UAE@XZ			; CEditWebLinkDlg::~CEditWebLinkDlg
EXTRN	??3CObject@@SGXPAX@Z:PROC			; CObject::operator delete
; Function compile flags: /Odtp /RTCsu
;	COMDAT ??_GCEditWebLinkDlg@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GCEditWebLinkDlg@@UAEPAXI@Z PROC			; CEditWebLinkDlg::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	push	ecx
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GCEditWebLinkDlg@@UAEPAXI@Z ENDP			; CEditWebLinkDlg::`scalar deleting destructor'
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ??1CEditWebLinkDlg@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1CEditWebLinkDlg@@UAE@XZ PROC				; CEditWebLinkDlg::~CEditWebLinkDlg, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	push	ecx
	...
	pop	ebp
	ret	0
??1CEditWebLinkDlg@@UAE@XZ ENDP				; CEditWebLinkDlg::~CEditWebLinkDlg
_TEXT	ENDS
EXTRN	?DDX_Text@@YGXPAVCDataExchange@@HAAV?$CStringT@_WV?$StrTraitMFC_DLL@_WV?$ChTraitsCRT@_W@ATL@@@@@ATL@@@Z:PROC ; DDX_Text
EXTRN	?DoDataExchange@CWnd@@MAEXPAVCDataExchange@@@Z:PROC ; CWnd::DoDataExchange
; Function compile flags: /Odtp /RTCsu
;	COMDAT ?DoDataExchange@CEditWebLinkDlg@@MAEXPAVCDataExchange@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_pDX$ = 8						; size = 4
?DoDataExchange@CEditWebLinkDlg@@MAEXPAVCDataExchange@@@Z PROC ; CEditWebLinkDlg::DoDataExchange, COMDAT
; _this$ = ecx
...
; 30   : 	//{{AFX_DATA_MAP(CEditWebLinkDlg)
; 31   : 	DDX_Text(pDX, IDC_WEBLINK, m_sWebLink);
	...
	push	edx
	call	?DDX_Text@@YGXPAVCDataExchange@@HAAV?$CStringT@_WV?$StrTraitMFC_DLL@_WV?$ChTraitsCRT@_W@ATL@@@@@ATL@@@Z ; DDX_Text
...
; 33   : }
	...
	pop	ebp
	ret	4
?DoDataExchange@CEditWebLinkDlg@@MAEXPAVCDataExchange@@@Z ENDP ; CEditWebLinkDlg::DoDataExchange
_TEXT	ENDS
PUBLIC	?GetThisMessageMap@CEditWebLinkDlg@@KGPBUAFX_MSGMAP@@XZ ; CEditWebLinkDlg::GetThisMessageMap
; Function compile flags: /Odtp /RTCsu
;	COMDAT ?GetMessageMap@CEditWebLinkDlg@@MBEPBUAFX_MSGMAP@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetMessageMap@CEditWebLinkDlg@@MBEPBUAFX_MSGMAP@@XZ PROC ; CEditWebLinkDlg::GetMessageMap, COMDAT
; _this$ = ecx

; 36   : BEGIN_MESSAGE_MAP(CEditWebLinkDlg, CDialog)
	...
	mov	DWORD PTR [ebp-4], -858993460		; ccccccccH
	mov	DWORD PTR _this$[ebp], ecx
	call	?GetThisMessageMap@CEditWebLinkDlg@@KGPBUAFX_MSGMAP@@XZ ; CEditWebLinkDlg::GetThisMessageMap
	add	esp, 4
	cmp	ebp, esp
	call	__RTC_CheckEsp
	mov	esp, ebp
	pop	ebp
	ret	0
?GetMessageMap@CEditWebLinkDlg@@MBEPBUAFX_MSGMAP@@XZ ENDP ; CEditWebLinkDlg::GetMessageMap
_TEXT	ENDS
EXTRN	?GetThisMessageMap@CDialog@@KGPBUAFX_MSGMAP@@XZ:PROC ; CDialog::GetThisMessageMap
;	COMDAT ?_messageEntries@?1??GetThisMessageMap@CEditWebLinkDlg@@KGPBUAFX_MSGMAP@@XZ@4QBUAFX_MSGMAP_ENTRY@@B
CONST	SEGMENT
?_messageEntries@?1??GetThisMessageMap@CEditWebLinkDlg@@KGPBUAFX_MSGMAP@@XZ@4QBUAFX_MSGMAP_ENTRY@@B DD 00H ; `CEditWebLinkDlg::GetThisMessageMap'::`2'::_messageEntries
	DD	00H
	DD	00H
	DD	00H
	DD	00H
	DD	00H
CONST	ENDS
;	COMDAT ?messageMap@?1??GetThisMessageMap@CEditWebLinkDlg@@KGPBUAFX_MSGMAP@@XZ@4U3@B
CONST	SEGMENT
?messageMap@?1??GetThisMessageMap@CEditWebLinkDlg@@KGPBUAFX_MSGMAP@@XZ@4U3@B DD FLAT:?GetThisMessageMap@CDialog@@KGPBUAFX_MSGMAP@@XZ ; `CEditWebLinkDlg::GetThisMessageMap'::`2'::messageMap
	DD	FLAT:?_messageEntries@?1??GetThisMessageMap@CEditWebLinkDlg@@KGPBUAFX_MSGMAP@@XZ@4QBUAFX_MSGMAP_ENTRY@@B
; Function compile flags: /Odtp /RTCsu
CONST	ENDS
;	COMDAT ?GetThisMessageMap@CEditWebLinkDlg@@KGPBUAFX_MSGMAP@@XZ
_TEXT	SEGMENT
?GetThisMessageMap@CEditWebLinkDlg@@KGPBUAFX_MSGMAP@@XZ PROC ; CEditWebLinkDlg::GetThisMessageMap, COMDAT
...
; 37   : 	//{{AFX_MSG_MAP(CEditWebLinkDlg)
; 38   : 		// NOTE: the ClassWizard will add message map macros here
; 39   : 	//}}AFX_MSG_MAP
; 40   : END_MESSAGE_MAP()

	mov	eax, OFFSET ?messageMap@?1??GetThisMessageMap@CEditWebLinkDlg@@KGPBUAFX_MSGMAP@@XZ@4U3@B
	pop	ebp
	ret	0
?GetThisMessageMap@CEditWebLinkDlg@@KGPBUAFX_MSGMAP@@XZ ENDP ; CEditWebLinkDlg::GetThisMessageMap
_TEXT	ENDS
