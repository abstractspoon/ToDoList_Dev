...
/////////////////////////////////////////////////////////////////////////////////
// This class is exported from TaskDatesUIExtensionBridge.dll

class CTaskDatesUIExtensionBridge : public IUIExtension
{
public:
	CTaskDatesUIExtensionBridge();
...
class CTaskDatesUIExtensionBridgeWindow : public IUIExtensionWindow
{
public:
	CTaskDatesUIExtensionBridgeWindow(ITransText* pTT);
...
protected:
   gcroot<TaskDatesUIExtensionCore^> m_wnd;
   ITransText* m_pTT;
...
protected:
	...
	//static bool Map(IUI_APPCOMMAND nCmd, TaskDatesControl::ExpandNode% expand);
};
...
{
   return new CTaskDatesUIExtensionBridge();
}
