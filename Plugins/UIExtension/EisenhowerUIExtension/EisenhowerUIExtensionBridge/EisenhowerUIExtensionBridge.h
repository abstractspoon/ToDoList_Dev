...
/////////////////////////////////////////////////////////////////////////////////
// This class is exported from EisenhowerUIExtensionBridge.dll

class CEisenhowerUIExtensionBridge : public IUIExtension
{
public:
	CEisenhowerUIExtensionBridge();
...
class CEisenhowerUIExtensionBridgeWindow : public IUIExtensionWindow
{
public:
	CEisenhowerUIExtensionBridgeWindow(ITransText* pTT);
...
protected:
	...
	//static bool Map(IUI_APPCOMMAND nCmd, EisenhowerControl::ExpandNode% expand);
};
...
{
   return new CEisenhowerUIExtensionBridge();
}
