...
{
	public class EisenhowerDragEventItem
	{
		public EisenhowerDragEventItem(TreeNode n)
		{
			if (n == null)
				return;

			var item = (n.Tag as EisenhowerItem);
	...
	public class EisenhowerDragEventArgs : EventArgs
	{
		public EisenhowerDragEventArgs(TreeNode node, TreeNode parent, TreeNode sibling, bool copy)
		{
			dragged = new EisenhowerDragEventItem(node);
			targetParent = new EisenhowerDragEventItem(parent);
			afterSibling = new EisenhowerDragEventItem(sibling);
			copyItem = copy;
		}

		public EisenhowerDragEventItem dragged = null;
		public EisenhowerDragEventItem targetParent = null;
		public EisenhowerDragEventItem afterSibling = null;
