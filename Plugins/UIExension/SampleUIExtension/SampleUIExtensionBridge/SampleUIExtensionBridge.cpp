...
void CSampleUIExtensionBridgeWindow::UpdateTasks(const ITaskList* pTasks, IUI_UPDATETYPE nUpdate, const I_ATTRIBUTE* pAttributes, int nNumAttributes)
{
...
bool CSampleUIExtensionBridgeWindow::WantTaskUpdate(I_ATTRIBUTE nAttribute) const
{
