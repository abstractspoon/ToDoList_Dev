...
{
	m_hIcon = Win32::LoadHIcon(L"JSViewUIExtensionBridge.dll", IDI_MINDMAP, 16, true);
}
...
CJSViewUIExtensionBridgeWindow::CJSViewUIExtensionBridgeWindow(ITransText* pTT) : m_pTT(pTT)
{
...
bool CJSViewUIExtensionBridgeWindow::Map(IUI_APPCOMMAND nCmd, MindMapControl::ExpandNode% expand)
{
	switch (nCmd)
	{
