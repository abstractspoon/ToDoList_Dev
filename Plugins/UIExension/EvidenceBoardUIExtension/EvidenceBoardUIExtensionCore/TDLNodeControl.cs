...
// 				return false;
		...
		public LabelTipInfo ToolHitTest(Point ptScreen)
		{
			...
			else if (taskItem.HasImage)
			{
				...
				{
					tip.Text = m_Trans.Translate("Toggle Image Visibility", Translator.CtrlType.ToolTip);
				...
				else if (taskItem.ImageCount > 1)
				{
					...
					if (tip.Rect.Contains(clientPos))
					{
						tip.Text = m_Trans.Translate("Next Image", Translator.CtrlType.ToolTip);
					...
					else // Back button
					{
						...
						if (tip.Rect.Contains(clientPos))
						{
							tip.Text = m_Trans.Translate("Previous Image", Translator.CtrlType.ToolTip);
