...
void CMindMapUIExtensionBridgeWindow::UpdateTasks(const ITaskList* pTasks, IUI_UPDATETYPE nUpdate, const I_ATTRIBUTE* pAttributes, int nNumAttributes)
{
...
bool CMindMapUIExtensionBridgeWindow::WantTaskUpdate(I_ATTRIBUTE nAttribute) const
{
